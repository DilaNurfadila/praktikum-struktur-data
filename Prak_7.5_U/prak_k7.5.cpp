...
int JmlActualMhs = 0; // Menyimpan 3 mahasiswa dalam memori
    ...
    else
    {
        while (loop)
        {
            ...
            else
            {
                ...
                {
                    Mhsw[JmlActualMhs].TAG = pasif;
                }

                getline(inpfile, str);
                Mhsw[JmlActualMhs].NilMTK.STD.UTS = stoi(str);
                getline(inpfile, str);
                Mhsw[JmlActualMhs].NilMTK.STD.UAS = stoi(str);
                getline(inpfile, str);
                Mhsw[JmlActualMhs].NilMTK.ALG.UTS = stoi(str);
                getline(inpfile, str);
                Mhsw[JmlActualMhs].NilMTK.ALG.UAS = stoi(str);
                getline(inpfile, str);
                Mhsw[JmlActualMhs].NilMTK.PBO.UTS = stoi(str);
                getline(inpfile, str);
                Mhsw[JmlActualMhs].NilMTK.PBO.UAS = stoi(str);
                getline(inpfile, str);
                Mhsw[JmlActualMhs].NilMTK.WEB.UTS = stoi(str);
                getline(inpfile, str);
                Mhsw[JmlActualMhs].NilMTK.WEB.UAS = stoi(str);
...
{
    fstream outfile;
    outfile.open("dtamhs.txt");

    for (int i = 0; i < JmlActualMhs; i++)
    {
        outfile << Mhsw[i].NAMA << endl;
        outfile << Mhsw[i].TAG << endl;
        outfile << Mhsw[i].NilMTK.STD.UTS << endl;
        outfile << Mhsw[i].NilMTK.STD.UAS << endl;
        outfile << Mhsw[i].NilMTK.ALG.UTS << endl;
        outfile << Mhsw[i].NilMTK.ALG.UAS << endl;
        outfile << Mhsw[i].NilMTK.PBO.UTS << endl;
        outfile << Mhsw[i].NilMTK.PBO.UAS << endl;
        outfile << Mhsw[i].NilMTK.WEB.UTS << endl;
        outfile << Mhsw[i].NilMTK.WEB.UAS << endl;
    }
    outfile.close();
}
...
int main()
{
    ...
    do
    {                    // display menu
        system("cls"); // Membersihkan atau menghapus tampilan dari terminal
        cout << endl;
        cout << "   Menu" << endl;
        cout << "   ====" << endl;
        cout << "esc. Exit" << endl;
        ...
        cout << "0. Load" << endl;
        cout << "Pilih : ";
        Pilih = _getch(); // input tanpa buffer, artinya kita tidak perlu menekan enter setelah memilih menu
        system("cls"); // Membersihkan atau menghapus tampilan dari terminal

        switch (Pilih) // Percabangan yang diambil dari variable Pilih
        {
        case 27: // Jika user memilih karakter 0
        {
